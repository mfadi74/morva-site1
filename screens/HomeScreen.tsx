...
export default function HomeScreen({ onOpenWorkout, onNavigatePlan }: { onOpenWorkout: (id: string) => void; onNavigatePlan: () => void }) {
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        ...
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity onPress={onNavigatePlan}>
            <Text style={styles.seeAll}>View Plan →</Text>
          </TouchableOpacity>
        </View>

        {todaySession ? (
          <WorkoutSessionCard session={todaySession} isToday onPress={onOpenWorkout} />
        ) : (
          <LinearGradient
